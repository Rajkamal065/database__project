...
from database import get_project_db_connection, get_cims_db_connection # Need both potentially
...
def add_player_to_team(current_user_id, current_user_role, team_id):
    """Adds a player (MemberID) to a spe cific team. Requires Admin or Coach role."""
